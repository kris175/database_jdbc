...
public class BookEntityRepositoryIntegrationTests {
    ...
    public void testThatBookCanBeCreatedAndRetrieved() {
        ...
        BookEntity book = TestDataUtil.getTestBook(author, "978-3-16-148410-0", "Effective Java");
    ...
    public void testThatMultipleBooksCanBeCreatedAndRetrieved() {
        ...
        BookEntity book1 = TestDataUtil.getTestBook(author, "978-3-16-148410-0", "Effective Java 1st Edition");
        underTest.save(book1);

        BookEntity book2 = TestDataUtil.getTestBook(author, "978-3-16-148410-1", "Effective Java 2nd Edition");
    ...
    public void testThatBookCanBeUpdated() {
        ...
        BookEntity book = TestDataUtil.getTestBook(author, "978-3-16-148410-0", "Original Title");
        underTest.save(book);
    ...
    public void testThatBookCanBeDeleted() {
        ...
        BookEntity book = TestDataUtil.getTestBook(author, "978-3-16-148410-0", "Book to be deleted");
        underTest.save(book);
